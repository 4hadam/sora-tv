                ...
                <div className="grid grid-cols-3 gap-3 sm:gap-4">
                    {[
                        ...
                        >
                            ...
                            <span className="text-xs sm:text-sm font-semibold text-white/90 text-center">
                                {stat.label}
                            </span>
            ...
            <div className="max-w-3xl mx-auto px-4 sm:px-6 pb-24 space-y-3">
                ...
                <div className="mt-6 text-sm text-white/60">
                    <p>
                        ...
                        <a
                            href="https://github.com/4hadam/sora-tv/issues"
                            target="_blank"
                            rel="noreferrer"
                            className="text-yellow-400 underline"
                        >
                            Report an issue or suggest a channel on GitHub
                        </a>
                        .
                    </p>
                </div>
